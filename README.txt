...
Files (to be run in this order):
  - lyme_model.R, encodes the spatial partial different equation model for tick-borne pathogen dynamics with host and tick movement, creates Figs. 2, 4, and 5 in the main text and Figs. S1-S4 in the supplement
